...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_WRITE_DATA =
            "com.example.bluetooth.le.ACTION_WRITE_DATA";
...
//            Log.e("aa",new String(data));
            if (data != null && data.length > 0) {
              ...
              Log.e("step2"," ’µΩ¡À"+new String(data));
              if(new String(data).equals("SZUBEES#"))
              {
            	  try
            	  {
            	    Thread.currentThread().sleep(3000);//∫¡√Î 
            	  }
            	  catch(Exception e){}
           	      sendMessage("1");
              }  
    ...
    {
    	myBluetoothGattService=mBluetoothGatt.getService(UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb"));
